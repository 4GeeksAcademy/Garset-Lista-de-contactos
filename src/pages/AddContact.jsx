...
const AddContact = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();//previene default del formulario

    try {
      const response = await fetch("https://playground.4geeks.com/contact/agendas/garset/contacts", {
        method: 'POST',
      ...
      navigate("/"); // Redirecciona a home después del ok
    } catch (error) {
 ...
 <div className="d-flex justify-content-center align-items-center min-vh-100 bg-light">
  <div className="card shadow p-4" style={{ width: '100%', maxWidth: '600px' }}>
    <div className="card-body">
      <h1 className="card-title text-center mb-4">Add Contact</h1>
